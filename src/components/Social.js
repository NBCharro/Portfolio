...
const Social = () => {
	return (
		<div className={classes.social}>
			...
			<a
				href="https://www.linkedin.com/in/nbcharro"
				target="_blank"
				rel="noreferrer noopener"
			...
			<a
				href="mailto:nbcharro@gmail.com"
				target="_blank"
				rel="noreferrer noopener"
