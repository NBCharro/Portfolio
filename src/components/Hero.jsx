function Hero() {
	return (
		<section className="px-3 pb-2 pt-5 mx-auto">
			<div className='flex justify-between'>
				<img className="h-6 animate-spin-slow" src="/images/nbcharroLogo.svg" alt="Icono de Java" />
			...
			<p className="text-gray-400 italic font-light text-xs py-0.5">{'</p>'}</p>
			<svg className="w-6 h-6 mx-auto animate-bounce text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
