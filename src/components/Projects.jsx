...
function Projects() {
	return (
		<section class="px-3 py-2 mx-auto">
			...
			<p className="text-gray-400 italic font-light text-xs py-0.5">{'</h2>'}</p>
			<div class="md:grid md:grid-cols-2 gap-4 md:justify-items-center md:items-center lg:grid-cols-4">
				{/* CARD 1 */}
				<div class='flex flex-col h-full'>
					<p className="text-gray-400 italic font-light text-xs py-0.5">{'<div>'}</p>
					<div class="border hover:border-primary border-gray-200 rounded-lg bg-gray-800 flex-grow flex flex-col justify-between">
						<picture>
							<img
								class="rounded-lg"
						...
						<div class="flex flex-nowrap justify-around lg:flex-wrap pb-4 lg:pb-2">
							<a href="https://greenlifenutrition.netlify.app/" target="_blank" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center bg-primary text-black rounded-lg hover:bg-secondary border-2 border-primary hover:border-white lg:my-2">
								Visitar pagina
							</a>
				...
				<div class='flex flex-col h-full'>
					...
					<div class="border hover:border-primary border-gray-200 rounded-lg bg-gray-800 flex-grow flex flex-col justify-between">
						...
						<div class="flex flex-nowrap justify-around lg:flex-wrap pb-4 lg:pb-2">
							<a href="https://ecolegas.netlify.app/" target="_blank" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center bg-primary text-black rounded-lg hover:bg-secondary border-2 border-primary hover:border-white lg:my-2">
								Visitar pagina
							</a>
							<a href="https://github.com/NBCharro/ecolegasProyecto" target="_blank" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center bg-primary text-black rounded-lg hover:bg-secondary border-2 border-primary hover:border-white lg:my-2">
								Enlace a Github
							</a>
						</div>
					</div>
				...
				<div class='flex flex-col h-full'>
					...
					<div class="border hover:border-primary border-gray-200 rounded-lg bg-gray-800 flex-grow flex flex-col justify-between">
						...
						<div class="flex flex-nowrap justify-around lg:flex-wrap pb-4 lg:pb-2">
							<a href="https://api-nutricion.onrender.com/" target="_blank" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center bg-primary text-black rounded-lg hover:bg-secondary border-2 border-primary hover:border-white lg:my-2">
								Visitar pagina
							</a>
							<a href="https://github.com/NBCharro/apiNutricion" target="_blank" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center bg-primary text-black rounded-lg hover:bg-secondary border-2 border-primary hover:border-white lg:my-2">
								Enlace a Github
							</a>
						</div>
					</div>
